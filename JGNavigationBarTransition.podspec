#
# Be sure to run `pod lib lint JGNavigationBarTransition.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Ucself' => 'lbj147123@163.com' }
  s.source           = { :git => 'https://github.com/Ucself/JGNavigationBarTransition.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'JGNavigationBarTransition/Classes/**/*'
  
  # s.resource_bundles = {
  #   'JGNavigationBarTransition' => ['JGNavigationBarTransition/Assets/*.png']
  # }
